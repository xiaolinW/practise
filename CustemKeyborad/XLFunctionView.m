...
-(void) header:(NSArray *)headers
{
    ...
    for (int i = 0; i < headers.count; i ++) {
        ...
        XLFaceView *face = [[XLFaceView alloc] initWithFrame:CGRectMake(x, y, 0, 0)];
        [face setImage:image ImageText:imageText];
        
        //face的回调，当face点击时获取face的图片
        __weak __block XLFunctionView *copy_self = self;
